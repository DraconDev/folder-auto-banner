//! Embedded shell wrappers for `f N` cd support.
//!
//! These are written to ~/.local/bin/ and sourced from .zshrc/.bashrc
//! during `f install`.

pub const ZSH_WRAPPER: &str = r#"# f shell function - enables `f N` to cd into directories
...
pub const BASH_WRAPPER: &str = r#"# f shell function - enables `f N` to cd into directories
# Installed by: f install
